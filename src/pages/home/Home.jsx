        ...
        <div className="row px-5">
          <div className="col-sm-12 col-md-3 col-lg-3 col-xl-3">
            ...
            <p className="">
              ...
              humanos con enfoques diferenciales, en la búsqueda de la igualdad
              social y de género, la construcción de una sociedad democrática,
              pacífica y respetuosa de las diferencias, que garantice el buen
          ...
          <div className="col-sm-12 col-md-4 col-lg-4 col-xl-4">
            ...
            <p>
              ...
              en los derechos humanos, la democracia, la equidad y el buen vivir
